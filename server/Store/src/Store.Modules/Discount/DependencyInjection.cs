...
{
    public static IServiceCollection AddDiscountModuleServices(this IServiceCollection services, IConfiguration configuration, List<Assembly> mediatrAssemblies)
    {
        // Settings setup
